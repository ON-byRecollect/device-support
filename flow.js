...
const NODES = {
  ...
  'ap.findmy': {
    ...
    steps:[
      ...
      { text:'設定ページに表示されるエラー内容を、下の選択肢から選んでください。' },
    ],
    options:[
  ...
  'a.owner': {
    ...
    steps:[
      { text:'表示された警告メッセージの内容をご確認ください。',
        image:'images/owner-warning.png' },
      { text:'この場合、表示されているアカウントの持ち主に、遠隔での Apple ID の関連付け解除を依頼する必要があります。' },
    ],
  ...
  'a.setup': {
    ...
    steps:[
      { text:'一部の AirPods の「探す」機能は、ペアリングしている iPhone のソフトウェアが最新バージョンのときのみ動作します。最新バージョンの iOS がインストールされていることを確認してください。',
        nav:['設定','一般','ソフトウェアアップデート'] },
      { text:'ペアリングしている iPhone の「探す」アプリの設定が、正しく完了しているかを確認してください。' },
      { text:'Apple Account の2ファクタ認証が有効になっているかを確認してください。' },
      { text:'iCloud キーチェーンが有効になっているかを確認してください。' },
  ...
  'a.advanced': {
    ...
    steps:[
      ...
      { text:'ペアリングしている iPhone で設定アプリを開き、Bluetooth をタップしてください。',
        nav:['設定','Bluetooth'] },
      { text:'自分のデバイス一覧に表示されている、ペアリング済みの AirPods の「i マーク」をタップしてください。' },
      { text:'AirPods のページ最下部にある「このデバイスの登録を解除」をタップしてください。' },
      { text:'Bluetooth の自分のデバイス一覧から、ペアリング済みの AirPods が削除されていることを確認してください。' },
      { text:'ペアリングしている iPhone で「探す」アプリを開いて、「デバイスを探す」の一覧からペアリング済みの AirPods が削除されていることを確認してください。',
        nav:['探す','デバイスを探す'] },
      { text:'設定アプリを開き、「Face ID とパスコード」をタップしてください。',
        nav:['設定','Face ID とパスコード'] },
      { text:'「盗難デバイスの保護」をタップしてください。' },
      { text:'盗難デバイスの保護がオンになっている場合は、この設定をオフにしてください。' },
      { text:'設定アプリのトップ画面に戻り、ページ最上部に表示されるご自身のアカウント名をタップしてください。' },
      { text:'Apple Account ページの「探す」をタップしてください。',
        nav:['設定','アカウント名','探す'] },
      { text:'「iPhone を探す」をタップし、オンになっている場合はオフにしてください。' },
      { text:'Apple Account ページへ戻り、iCloud をタップしてください。',
        nav:['設定','アカウント名','iCloud'] },
      { text:'「パスワード」をタップし、「パスワードとキーチェーン」の「この iPhone を同期」がオンになっている場合は、オフにしてください。',
        nav:['iCloud','パスワード'] },
      { text:'1〜14 の設定を保持したまま、iPhone を再起動させてください。' },
      { text:'iPhone を再起動したら、設定アプリを開いてください。' },
      { text:'ページ最上部に表示されるご自身のアカウント名をタップしてください。' },
      { text:'Apple Account ページの「探す」をタップしてください。',
        nav:['設定','アカウント名','探す'] },
      { text:'「iPhone を探す」をタップしてオンにしてください。「探すネットワーク」がオフのままの場合は、オンにしてください。' },
      { text:'Apple Account ページへ戻り、iCloud をタップしてください。',
        nav:['設定','アカウント名','iCloud'] },
      ...
      { text:'設定アプリを開いてください。' },
      { text:'Bluetooth をタップし、自分のデバイス一覧に AirPods が表示されていることを確認してください。',
        nav:['設定','Bluetooth'] },
      { text:'自分のデバイス一覧に表示されている、ペアリング済みの AirPods の「i マーク」をタップしてください。' },
      { text:'AirPods の設定画面の中ほどにある「バッテリー」をタップしてください。' },
      { text:'バッテリー充電の最適化がオフになっている場合は、オンに変更してください。' },
      { text:'ページを一つ戻り、AirPods ページの最下部にある情報から「バージョン」をタップしてください。' },
  ...
  'a.firmware': {
    ...
    steps:[
      { text:'iPhone の設定アプリを開き、「一般」から「ソフトウェアアップデート」をタップしてください。ソフトウェアが最新ではない場合は、アップデートを行ってください。',
        nav:['設定','一般','ソフトウェアアップデート'] },
      ...
      { text:'iPhone の設定アプリを開き、Bluetooth をタップして、自分のデバイス一覧に AirPods が表示されていることを確認してください。',
        nav:['設定','Bluetooth'] },
      { text:'自分のデバイス一覧に表示されている、ペアリング済みの AirPods の「i マーク」をタップしてください。' },
  ...
  'a.findmy_reset': {
    ...
    steps:[
      ...
      { text:'充電ケースの蓋を開けたまま、「探す」アプリを開いてください。',
        nav:['探す','デバイスを探す'] },
      { text:'「デバイスを探す」の一覧から、削除したい AirPods のアイコンをタップしてください。' },
      { text:'設定ページの最下部に表示される「このデバイスを削除」をタップしてください。' },
